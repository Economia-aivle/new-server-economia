...
SECRET_KEY = "django-insecure-r4k$$a*h05qtjq-=1=@vztptek4xl4wpdq@2hzg))%07qqg4%c"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

AUTH_USER_MODEL = 'economia.Player'
...
AUTHENTICATION_BACKENDS = [
    'economia.backends.CustomBackend',
...
MIDDLEWARE = [
    ...
    'educations.middleware.ResetNumMiddleware',
]
